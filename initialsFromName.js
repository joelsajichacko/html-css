...
let createInitialsFromName = (name) => {
  ...
  if (names.length === 1) console.log(names[0].substring(0, 2).toUpperCase());
  else console.log(names[0].charAt(0) + names[names.length - 1].charAt(0));
};

createInitialsFromName("John");
